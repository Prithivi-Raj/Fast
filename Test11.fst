...
---------------------- INPUT FILES ---------------------------------------------
"WP_Baseline/Test11_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"WP_Baseline/WP_Baseline_AeroDyn_Dynin.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"WP_Baseline/Test11_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
